...
let InventoryController = class InventoryController {
    ...
    getInventoryItem(rawMaterialId) {
    ...
    getInventoryHistory(rawMaterialId) {
        return this.inventoryService.getInventoryHistory(rawMaterialId);
    }
};
exports.InventoryController = InventoryController;
__decorate([
    (0, microservices_1.MessagePattern)({ cmd: 'get-inventory' }),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", void 0)
], InventoryController.prototype, "getInventory", null);
__decorate([
    (0, microservices_1.MessagePattern)({ cmd: 'get-inventory-item' }),
...
__decorate([
    (0, microservices_1.MessagePattern)({ cmd: 'update-inventory' }),
    __param(0, (0, microservices_1.Payload)()),
    __metadata("design:type", Function),
...
__decorate([
    (0, microservices_1.MessagePattern)({ cmd: 'adjust-inventory' }),
    __param(0, (0, microservices_1.Payload)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", void 0)
...
__decorate([
    (0, microservices_1.MessagePattern)({ cmd: 'get-inventory-history' }),
    __param(0, (0, microservices_1.Payload)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number]),
    __metadata("design:returntype", void 0)
